...
async function loadPage( x, y, z, scriptName, delayTime, browserPromise ) {
...
async function makeTile( pageAndData ) {
  ...
  try {
    ...
    const page = pageAndData.page
    const bBox = pageAndData.bBox
